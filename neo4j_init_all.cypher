...
SET j.originJobId = toInteger(row.originJobId),
    j.title = row.title,
...
// ==================== 6. JOB-SKILL RELATIONSHIPS (skillId 컬럼) ====================
...
UNION ALL
MATCH ()-[r:REQUIRES_SKILL]->() RETURN 'Job_Requires_Skills' AS label, count(r) AS count;
