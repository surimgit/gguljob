...
public class JoinRequestEvent {
    ...
    public JoinRequestEvent(Long targetUserId, Long projectId, String message, String category) {
    ...
    public JoinRequestEvent(Long targetUserId, Long projectId, String message, String category, LocalDateTime createdAt) {
        this.targetUserId = targetUserId;
        this.projectId = projectId;
        this.message = message;
        this.category = category;
