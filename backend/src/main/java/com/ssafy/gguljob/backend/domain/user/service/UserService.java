...
public class UserService {
    ...
    public MemberFilterResponseDto getMemberFilters() {
        ...
        List<MemberFilterResponseDto.FilterOptionDto> positions = java.util.Arrays
                .stream(com.ssafy.gguljob.backend.domain.user.type.PositionType.values())
        ...
        List<MemberFilterResponseDto.FilterOptionDto> levels = java.util.Arrays
                .stream(com.ssafy.gguljob.backend.domain.user.type.ExperienceLevel.values())
                .map(level -> new MemberFilterResponseDto.FilterOptionDto(level.name(),
