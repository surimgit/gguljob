...
const GitHubLoginButton = () => {
  ...
  return (
    <button
      ...
      className="group relative flex items-center gap-2 bg-text-primary text-white px-4 py-2 rounded-lg text-sm font-medium hover:opacity-80 transition-opacity"
    >
